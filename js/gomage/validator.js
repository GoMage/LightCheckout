...
Validation.add('glc-email-confirmation', 'Please make sure your emails match.', function (v) {
    var confirmation = $$('.glc-email-confirmation')[0];
    var parent = $(confirmation.readAttribute('data-parent-id'));
    if (!parent) {
        return true;
    }
    return confirmation.value == parent.value;
});
...
Object.extend(Validation, {
    defaultOptions: {
        ...
        onFormValidate: function (result, form) {
            Validation.AfterFormValidate(result, form)
        },
